...
const RotFlip::TransTable RotFlip::flipXTable =
{
    // rfDefault ->
    rfFlipX,
    // rfRotate90 ->
...
const RotFlip::TransTable RotFlip::flipYTable =
{
    // rfDefault ->
    rfFlipY,
    // rfRotate90 ->
...
const RotFlip::TransTable RotFlip::rotate90Table =
{
    // rfDefault ->
    rfRotate90,
    // rfRotate90 ->
...
const RotFlip::TransTable RotFlip::rotate180Table =
{
    // rfDefault ->
...
const RotFlip::TransTable RotFlip::rotate270Table =
{
    // rfDefault ->
...
const RotFlip::CornerTable RotFlip::mapCornerTable =
{
    // rfDefault ->
    { 0, 1, 2, 3 },
    // rfRotate90 ->
...
const RotFlip::CornerTable RotFlip::realCornerTable =
{
    // rfDefault ->
    { 0, 1, 2, 3 },
    // rfRotate90 ->
...
void drawImageWithRotFlip(const Gosu::Image& image, double x, double y, Gosu::ZPos z,
    RotFlip rf, double factorX, double factorY,
    Gosu::Color c, Gosu::AlphaMode mode)
{
    drawImageWithRotFlip(image, x, y, z, rf, factorX, factorY, c, c, c, c, mode);
}

void drawImageWithRotFlip(const Gosu::Image& image, double x, double y, Gosu::ZPos z,
    RotFlip rf, double factorX, double factorY,
    Gosu::Color c1, Gosu::Color c2, Gosu::Color c3, Gosu::Color c4, Gosu::AlphaMode mode)
{
    double offsetX;
    double offsetY;
    ...
    if (rf.rotated())
    {
        offsetX = image.height() * factorY / 2;
        offsetY = image.width() * factorX / 2;
    }
    else
    {
        offsetX = image.width() * factorX / 2;
        offsetY = image.height() * factorY / 2;
    }
